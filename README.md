...
| [inisort](https://github.com/bAndie91/tools/blob/master/usr/bin/inisort) | Perl | Beerware | Sort the sections and keys of the given INI file based on another INI file. |
